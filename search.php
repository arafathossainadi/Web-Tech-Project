	...
	<table width="100%" border="0" cellspacing="0" align="center">
		...
		<tr bgcolor="#D2D2D2">
			<td >
				...
				<table align="center">
					<tr>
						<td><img src="Image/banner2.jpg" width="100%"></td>
						<td><img src="Image/banner3.jpg" width="100%"></td>
					</tr>
				</table>
			</td>
		</tr>
						...
						<td bgcolor="#C0C0C0">
							<table>
								...
								<tr>
									...
									<td align="center">
										<div class="container">
										  <img src="Image/product1.jpg" border="1" alt="Avatar" class="image">
									...
									<td align="center">
										<div class="container">
										  <img src="Image/product2.png" border="1" alt="Avatar" class="image">
										  <a href="publicproductdetails.php" target="_blank">
										  	<div class="middle">
										  	  <div class="text">See Details</div>
										  	</div>
									...
									<td align="center">
										<div class="container">
										  <img src="Image/product3.png" border="1" alt="Avatar" class="image">
										  <a href="publicproductdetails.php" target="_blank">
										  	<div class="middle">
										  	  <div class="text">See Details</div>
										  	</div>
